...
all:
	...
	/usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string \"0.3\"" Twitchler.app/Contents/Info.plist
	/usr/libexec/PlistBuddy -c 'Add :NSHumanReadableCopyright string © 2016 Florian Zwoch' Twitchler.app/Contents/Info.plist
